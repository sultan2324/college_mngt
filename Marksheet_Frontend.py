...
def marksheet():
       ...
       Frame_1 = LabelFrame(root, width = 1200, height = 400, font = ('arial',20,'bold'), bg = 'orange red', bd = 10, \
                            text = 'Student Details', relief = 'ridge')
       Frame_1.grid(row = 1, column = 0, pady = 20, padx = 20)


       #=================================================Labels and Entries for Frame_1===============================================
       Label_Name = Label(Frame_1, text = 'Name', font = ('arial',15,'bold'), bg = 'orange red')
       Label_Name.grid(row = 0, column = 0, padx = 80)
       Entry_Name = Entry(Frame_1, font = ('arial',15), width = 25, textvariable = name)
       Entry_Name.grid(row = 0, column = 1, padx = 5, pady = 5)

       Label_Roll_no = Label(Frame_1, text = 'Roll Number', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_Father_Name = Label(Frame_1, text = 'Father Name', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_Mother_Name = Label(Frame_1, text = 'Mother Name', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_DOB = Label(Frame_1, text = 'Date of Birth', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_Gender = Label(Frame_1, text = 'Gender', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_School = Label(Frame_1, text = 'School Name', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       Label_Email = Label(Frame_1, text = 'Email ID', font = ('arial',15,'bold'), bg = 'orange red')
       ...
       #========================================================Frame_2==================================================================       
       Frame_2 = LabelFrame(root, width = 1200, height = 400, font = ('arial',20,'bold'), bg = 'orange red', bd = 10 \
       ...
       Label_Subject = Label(Frame_2, text = 'SUBJECT', font = ('arial',16,'bold'), bg = 'orange red')
       Label_Subject.grid(row = 3, column = 0, padx = 50, pady = 10)

       Label_obt_Marks = Label(Frame_2, text = 'MARKS OBTAINED', font = ('arial',16,'bold'), bg = 'orange red')
       Label_obt_Marks.grid(row = 3, column = 1, padx = 20)

       Label_Subject = Label(Frame_2, text = 'PASSING MARKS', font = ('arial',16,'bold'), bg = 'orange red')
       Label_Subject.grid(row = 3, column = 2, padx = 20)

       Label_obt_Marks = Label(Frame_2, text = 'TOTAL MARKS', font = ('arial',16,'bold'), bg = 'orange red')
       Label_obt_Marks.grid(row = 3, column = 3, padx = 20)

       Label_1 = Label(Frame_2, text = 'MATHEMATICS', font = ('arial',14), bg = 'orange red')
       Label_1.grid(row = 4, column = 0)
       Label_2 = Label(Frame_2, text = 'PHYSICS', font = ('arial',14), bg = 'orange red')
       Label_2.grid(row = 5, column = 0)
       Label_3 = Label(Frame_2, text = 'CHEMISTRY', font = ('arial',14), bg = 'orange red')
       Label_3.grid(row = 6, column = 0)
       Label_4 = Label(Frame_2, text = 'HINDI', font = ('arial',14), bg = 'orange red')
       Label_4.grid(row = 7, column = 0)
       Label_5 = Label(Frame_2, text = 'ENGLISH', font = ('arial',14), bg = 'orange red')
       Label_5.grid(row = 8, column = 0)
       Label_6 = Label(Frame_2, text = 'GRAND TOTAL', font = ('arial',16), bg = 'orange red')
       Label_6.grid(row = 9, column = 0)
       Label_7 = Label(Frame_2, text = 'PERCENTAGE', font = ('arial',16,'bold'), bg = 'orange red')
       Label_7.grid(row = 10, column = 0)
       Label_8 = Label(Frame_2, text = 'CGPA', font = ('arial',16,'bold'), bg = 'orange red')
       Label_8.grid(row = 10, column = 2)
       Label_9 = Label(Frame_2, text = 'GRADE', font = ('arial',16,'bold'), bg = 'orange red')
       Label_9.grid(row = 10, column = 4)
       Label_10 = Label(Frame_2, text = 'DIVISION', font = ('arial',16,'bold'), bg = 'orange red')
       Label_10.grid(row = 11, column = 0)
       Label_10 = Label(Frame_2, text = 'RESULT', font = ('arial',16,'bold'), bg = 'orange red')
