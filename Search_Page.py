...
class Window_1():
       def __init__(self, master):
              ...
              self.roll = StringVar()
              frame = LabelFrame(self.master, width = 1000, height = 100, font = ('arial',30,'bold'), relief = 'ridge', bd = 15, bg = 'teal')
              frame.grid(row = 1, column = 0, padx = 200, pady = 200)

              label = Label(frame, text = 'Enter Roll Number', font = ('arial',25,'bold'), bg = 'teal' )
